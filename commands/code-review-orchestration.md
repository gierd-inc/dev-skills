...
<!-- auto-generated from skills/gierd/code-review-orchestration/SKILL.md -->

Invoke the `code-review-orchestration` skill via the Skill tool, then apply it to the user's current task.
