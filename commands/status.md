...
2. Read `.agency/<slug>/state.json` and print:
   - `feature_slug`
   - `phase`
...
4. Print last 5 entries from `.agency/<slug>/team-lead/log.md` if present.

5. If `.agency/<slug>/state.json` contains a `.usage` key, print a one-line cost summary:
