...
A collection of agent skills (slash commands and behaviors) loaded by Claude Code as the `gierd` plugin. Skills are organized into buckets and consumed by per-repo configuration emitted by `/setup-gierd-skills`.
